  ...
  return (
    ...
    <Nav />
      ...
      <div className={Style.photo_con}>
        <img src="nft3.jpeg" alt="" />
        </div>
        <div className={Style.description}>
          <h2>Description</h2>
            <p>As temporal replicas become reconfigured through boundaried and repetitive practice, the viewer is left with a hymn to the edges of our existence.</p>
          ...
          <div>
            <div className={Style.bid}>
              ...
              <p>Bid placed for <span className={Style.white}>8.76 ETH</span> 7 hours ago
              by <span className={Style.white}>@goNgo</span> </p>
            </div>
            <div className={Style.bid}>
              <img src="av5.jpeg" alt="" className={Style.avatarpic}/>
              <p>Bid placed for <span className={Style.white}>9.05 ETH</span>  3 hours ago
              by <span className={Style.white}>@spiderboy</span> </p>
            </div>
            <div className={Style.bid}>
              <img src="av3.png" alt="" className={Style.avatarpic}/>
              <p>Bid placed for <span className={Style.white}>11.46 ETH</span> 1 hours ago
